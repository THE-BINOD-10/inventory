...
function ServerSideProcessingCtrl($scope, $http, $state, $compile, Session, Auth, $timeout, Service) {
  ...
  vm.model_data = {
                    ...
                    'sku_pack_config': false, 'central_order_reassigning':false,'sno_in_invoice':false, 'po_sub_user_prefix': false,
                  };
  vm.all_mails = '';
  vm.switch_names = {1:'send_message', 2:'batch_switch', 3:'fifo_switch', 4: 'show_image', 5: 'back_order',
                     ...
                     74: 'sku_pack_config', 75: 'po_sub_user_prefix',76:'sno_in_invoice'}
