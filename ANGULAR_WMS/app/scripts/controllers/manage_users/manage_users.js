...
angular.module('urbanApp', ['datatables'])
  .controller('ManageUsers',['$scope', '$http', '$state', '$timeout', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service', ServerSideProcessingCtrl]);
...
function ServerSideProcessingCtrl($scope, $http, $state, $timeout, Session, DTOptionsBuilder, DTColumnBuilder, colFilters, Service) {
    ...
    vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('Email')
          .withTitle('Email'),
        DTColumnBuilder.newColumn('Member of Groups')
          .withTitle('Member of Groups'),
    ];
