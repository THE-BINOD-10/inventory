...
angular.module('urbanApp', ['datatables'])
  .controller('ServiceMasterDOATable',['$scope', '$http', '$state', '$timeout', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service', ServerSideProcessingCtrl]);
...
function ServerSideProcessingCtrl($scope, $http, $state, $timeout, Session, DTOptionsBuilder, DTColumnBuilder, colFilters, Service) {
  ...
  vm.filters = {'datatable': 'ServiceMasterDOA', 'search0':'', 'search1':'', 'search2':'', 'search3':'', 'search4':'', 'search5':''}
...
//    });
     vm.dtColumns = [
      ...
      DTColumnBuilder.newColumn('sku_desc').withTitle('Service Description'),
      DTColumnBuilder.newColumn('asset_type').withTitle('Service Type'),
      DTColumnBuilder.newColumn('sku_category').withTitle('Service Category'),
      DTColumnBuilder.newColumn('sku_class').withTitle('Service Class'),
...
//app.controller('AssetMasterDOATable',['$scope', '$http', '$state', '$timeout', 'Session','DTOptionsBuilder', 'DTColumnBuilder', '$log', 'colFilters' , 'Service', '$rootScope', '$modal',ServerSideProcessingCtrl]);
//
