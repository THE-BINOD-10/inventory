...
function ServerSideProcessingCtrl($scope, $http, $state, $timeout, Session, DTOptionsBuilder, DTColumnBuilder, colFilters, Service, $modal, $log) {
    ...
    var empty_data = {
                       product_type: "",
                       data: [{tax_type: "intra_state", min_amt: "", max_amt: "", sgst_tax: "", cgst_tax: "", igst_tax: "", new_tax: true}]
                     }
    vm.update = false;
    vm.title = "Add Tax"
    vm.model_data = {};
...
app.controller('TaxPOPCtrl', function ($scope, $http, $state, $timeout, Session, colFilters, Service, $stateParams, $modalInstance, items) {
  ...
  vm.add = function() {
    vm.model_data.data.push({tax_type: "intra_state", min_amt: "", max_amt: "", sgst_tax: "", cgst_tax: "", igst_tax: "", new_tax: true})
  }
