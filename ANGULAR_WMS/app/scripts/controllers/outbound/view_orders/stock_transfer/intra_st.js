...
angular.module('urbanApp', ['datatables'])
  .controller('StockTransferOrdersIntra',['$scope', '$http', '$state', '$compile', '$timeout', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service',  '$q', 'Data', '$modal', '$log', ServerSideProcessingCtrl]);
    ...
    vm.changeDtFields = function(flag){
      ...
      if (flag) {
       ...
       .withOption('ajax', {
              ...
              type: 'POST',
              data: {'datatable': 'AltStockTransferOrders', 'special_key': 'ST_INTRA'},
              xhrFields: {
