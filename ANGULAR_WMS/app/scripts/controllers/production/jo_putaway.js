...
angular.module('urbanApp', ['datatables'])
  .controller('JOPutawayCtrl',['$scope', '$http', '$state', '$timeout', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service', ServerSideProcessingCtrl]);
...
function ServerSideProcessingCtrl($scope, $http, $state, $timeout, Session, DTOptionsBuilder, DTColumnBuilder, colFilters, Service) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
       .withOption('ajax', {
              ...
              type: 'POST',
              data: {'datatable': 'PutawayConfirmation'},
              xhrFields: {
