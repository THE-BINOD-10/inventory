...
//  .controller('AllocationReportCtrl',['$scope', '$http', '$state', '$compile', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service', 'Data', ServerSideProcessingCtrl]);
//
...
//     .withOption('ajax', {
//            url: Session.url+'get_allocation_filter/',
//            type: 'GET',
//            data: vm.model_data,
//            xhrFields: {
...
angular.module('urbanApp', ['datatables'])
  .controller('AllocationReportCtrl',['$scope', '$http', '$state', '$compile', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service', ServerSideProcessingCtrl]);
...
function ServerSideProcessingCtrl($scope, $http, $state, $compile, Session, DTOptionsBuilder, DTColumnBuilder, colFilters, Service) {
  ...
  vm.report_data = {};
  vm.service.get_report_data("allocation_report").then(function(data) {
  ...
  vm.close = close;
  function close() {
    vm.title = "Allocation Report";
    $state.go('app.reports.AllocationReport');
  }
  vm.empty_data = {
                    'from_date': '',
                    'to_date': '',
