...
angular.module('urbanApp', ['datatables'])
  .controller('CreditNoteFormReportCtrl',['$scope', '$http', '$state', '$compile', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service', ServerSideProcessingCtrl]);
...
function ServerSideProcessingCtrl($scope, $http, $state, $compile, Session, DTOptionsBuilder, DTColumnBuilder, colFilters, Service) {
  ...
  vm.print = print;
  vm.print = function() {
    vm.service.print_data(vm.print_page, "Credit Note Form");
  }

  vm.reports = {}
  vm.toggle_rtv_sku_wise = function() {
    var send = {};
	var name = 'credit_note_form_report';
