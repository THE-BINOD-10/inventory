...
angular.module('urbanApp', ['datatables'])
  .controller('MRPPOReportCtrl',['$scope', '$http', '$state', '$compile', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service', ServerSideProcessingCtrl]);
  ...
  vm.service.apiCall("get_report_data/", "GET", {report_name: name}).then(function(data) {
  	if(data.message) {
        ...
        vm.service.get_report_dt(vm.empty_data, vm.report_data).then(function(datam) {
          ...
          vm.report_data['excel_name'] = 'get_mrp_po_report'
        })
  	  }
  	}
  });
