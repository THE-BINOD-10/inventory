...
angular.module('urbanApp', ['datatables'])
  .controller('StockReconciliationReportCtrl',['$scope', '$http', '$state', '$compile', 'Session', 'DTOptionsBuilder', 'DTColumnBuilder', 'colFilters', 'Service', ServerSideProcessingCtrl]);
...
function ServerSideProcessingCtrl($scope, $http, $state, $compile, Session, DTOptionsBuilder, DTColumnBuilder, colFilters, Service) {
  ...
  vm.toggle_rtv_sku_wise = function() {
    var send = {};
	var name = 'stock_reconsiliation_report';
