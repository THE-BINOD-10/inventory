  ...
  return {
    ...
    link: function (scope, element, $window) {
      element.find('a').on('click', function (e) {
        ...
        /*
        if (parentLink.parents('li').length > 0) {
          //otherLinks.removeClass('open');
          parentLink.parents('li').addClass('active');
        }*/
    ...
    controller: function ($scope) {
      ...
      $('.user-section').on('mouseenter', function (e) {
      if ($('.user-section').width() == 50) {
        $('.user-section').addClass("small");
      } else {
        $('.user-section').removeClass("small");
      }
      })
    }
  };
