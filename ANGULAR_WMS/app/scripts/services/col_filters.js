  ...
  vm.download_excel = download_excel;
    function download_excel() {
      ...
      if (Session.roles.permissions['central_order_reassigning'] == true && vm.search.datatable == "OrderView") //for 72 networks
      {
        ...
        data['Branch Name'] = 'Branch Name';data['Branch ID'] = 'Branch ID'; data['Loan Proposal ID'] ='Loan Proposal ID';data ['Loan Proposal Code'] ='Loan Proposal Code';data ['Client Code'] ='Client Code';
