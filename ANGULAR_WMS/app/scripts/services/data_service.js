  ...
  //View Orders
    ...
    if (self.industry_type == 'FMCG') {
      self.dispatch_summary_report = {
                              ...
                              view: 'normalView',
                              tb_headers: {'normalView': ['Order ID', 'WMS Code', 'WMS MRP', 'Child SKU', 'Child SKU MRP', 'Child SKU Weight', 'Description', 'SKU Category', 'Location', 'Quantity', 'Picked Quantity', 'Date', 'Time'],
      ...
      self.dispatch_summary_report = {
                              ...
                              alternate_view: false,
                              view: 'normalView',
                              tb_headers: {'normalView': ['Order ID', 'WMS Code', 'WMS MRP', 'Child SKU', 'Description', 'SKU Category', 'Location', 'Quantity', 'Picked Quantity', 'Date', 'Time'],
                                           'serialView': ['Order ID', 'WMS Code', 'Description', 'SKU Category', 'Customer Name', 'Serial Number', 'Date', 'Time'],
                                           'customerView': ['Customer ID', 'Customer Name', 'WMS Code', 'Description', 'SKU Category', 'Quantity', 'Picked Quantity']}
                           }
    }
