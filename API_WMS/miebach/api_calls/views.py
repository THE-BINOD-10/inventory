...
def create_update_sku_storehippo(store_hippo_data, user_obj):
    ...
    stockone_data = {}
    stockone_data['sku_code'] = store_hippo_data.get('uniquesku', '')[0]
    stockone_data['wms_code'] = store_hippo_data.get('uniquesku', '')[0]
    stockone_data['sku_desc'] = store_hippo_data.get('description', '')
    stockone_data['sku_group'] = ''
    stockone_data['sku_type'] = ''
    stockone_data['sku_category'] = store_hippo_data.get('categories', '')[0]
    ...
    stockone_data['image_url'] = store_hippo_data.get('images','')[0]['tempSrc']
    ...
    try:
        sku_obj = SKUMaster.objects.filter(**{'user':user_obj.id, 'sku_code':store_hippo_data.get('uniquesku', '')[0]})
        if not sku_obj:
