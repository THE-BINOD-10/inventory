...
class PurchaseOrder(models.Model):
    ...
    class Meta:
        ...
        index_together = (('po_number',), ('order_id', 'open_po'), ('order_id', 'open_po', 'received_quantity'), ('po_number', 'open_po'),('open_po','creation_date'),('open_po',))
        permissions = [
...
class MRP(models.Model):
    ...
    supplier_id = models.CharField(max_length=20, null=True, blank=True)
