...
urlpatterns += [
    ...
    url(r'^get_extra_row_data/$', get_extra_row_data),
    ...
    url(r'^get_emails_list/$', get_emails_list),
    ...
    url(r'^stock_transfer_inter_invoice_data/$', stock_transfer_inter_invoice_data),
