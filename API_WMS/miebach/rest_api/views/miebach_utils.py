...
PERMISSION_DICT = OrderedDict((
    ...
    # Masters
    ("MASTERS_LABEL", (("SKU Master Edit", "add_skumaster"),("SKU Master View", "view_skumaster"), ("Location Master", "add_locationmaster"),
                       ("Supplier Master Edit", "add_suppliermaster"), ("Supplier Master View", "view_suppliermaster"),
                       ("Source SKU Mapping Edit", "add_skusupplier"), ("Source SKU Mapping View", "view_skusupplier"),
                       ("Project Master", "add_corporatemaster"),
                       ("Reseller Corporate Mapping", "add_corpresellermapping"),
                       ("Customer Master Edit", "add_customermaster"), ("Customer Master View", "view_customermaster"), ("Customer SKU Mapping", "add_customersku"),
                       ...
                       ('Pricing Master Edit', 'add_pricemaster'),('Pricing Master View', 'view_pricemaster'), ('Network Master', 'add_networkmaster'),
